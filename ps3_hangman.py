...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while True:
           ...
           g=input("please place a guess:")
         
           if not(g in lettersGuessed):
              ...
              if g in secretWord:
                 ...
                 print("Good guess:"+getGuessedWord(secretWord,lettersGuessed))
                   ...
                   print("oops wrong guess"+getGuessedWord(secretWord,lettersGuessed))
                   guess=guess-1
           else:
           ...
           if (isWordGuessed(secretWord, lettersGuessed))==True or guess==0:
                break
